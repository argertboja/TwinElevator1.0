...
HD_PWD='C:/Users/Argert/Desktop/TwinElevator1.0/TwinElevator1.0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TwinElevatorsTopModule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TwinElevatorsTopModule.tcl -notrace
