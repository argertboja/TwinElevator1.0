...
HD_PWD='C:/Users/Argert/Desktop/TwinElevator1.0/TwinElevator1.0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TwinElevatorsTopModule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TwinElevatorsTopModule.tcl
