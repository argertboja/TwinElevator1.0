...
module TwinElevatorsTopModule(  input logic clk, callElevator, [3:0]floor, JB_in,output [3:0] JB_out,
	...
	// FIRST ELEVATOR
    DriverController elev1 (clk, clk_2s, go, enableElev1, cState1, des1, newSt1, out, on1); 
	QUEUE queue1 (clk, clk_2s, enableElev1, keyCode, newSt1, go, cState1, des1);
    
    KeyboardController  keyboard(clk, enablerows, JB_in, keyCodeInternal, callElevator,  JB_out , keyCode); 
    
    //SECOND ELEBATOR
    DriverController elev2 (clk, clk_2s, go2, enableElev2, cState2, des2,  newSt2, out2, on2); 
